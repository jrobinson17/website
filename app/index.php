...
<html lang="en">
  <head>
    ...
    <title>Blockchain Assistant</title>
  ...
  <body class="bg-dark">
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark bg-super-dark">
      <a class="navbar-brand" href="#">Blockchain Coin Dashboard</a>
...
/*
    ...
    <!-- Source code https://github.com/jrobinson17/cryptocurrency-dashboard/ -->
